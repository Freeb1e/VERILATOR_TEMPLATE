// Vivado-friendly wrapper for the reference 32-multiplier array.
//
// The register map matches vsrc/vivado_reconfig_mul_core_wrapper.sv so that
// resource reports can be compared with the same top-level IO shape.
//
// 32-bit register map:
...
(* use_dsp = "no" *)
module vivado_ref_multiplier_array_wrapper #(
